...
namespace amalgam { namespace example_plugin {

class hello_api_plugin : public amalgam::app::plugin
{
   public:
      /**
       ...
       */
      hello_api_plugin( amalgam::app::application* app );
...
{
   public:
      hello_api_api( const amalgam::app::api_context& ctx );
...
FC_API( amalgam::example_plugin::hello_api_api,
   (get_message)
   )

namespace amalgam { namespace example_plugin {

hello_api_plugin::hello_api_plugin( amalgam::app::application* app ) : amalgam::app::plugin(app) {}
...
hello_api_api::hello_api_api( const amalgam::app::api_context& ctx ) : _app(ctx.app) {}
...
/**
 * The AMALGAM_DEFINE_PLUGIN() macro will define a amalgam::plugin::create_hello_api_plugin()
 * factory method which is expected by the manifest.
 */

AMALGAM_DEFINE_PLUGIN( hello_api, amalgam::example_plugin::hello_api_plugin )
