...
FC_REFLECT_TYPENAME( amalgam::protocol::block_header_extensions )

FC_REFLECT( amalgam::protocol::block_header, (previous)(timestamp)(witness)(transaction_merkle_root)(extensions) )
FC_REFLECT_DERIVED( amalgam::protocol::signed_block_header, (amalgam::protocol::block_header), (witness_signature) )
