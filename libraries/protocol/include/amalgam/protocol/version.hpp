...
/*
 * This class represents the basic versioning scheme of the Amalgam blockchain.
...
{
   class variant;
   void to_variant( const amalgam::protocol::version& v, variant& var );
   void from_variant( const variant& var, amalgam::protocol::version& v );

   void to_variant( const amalgam::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, amalgam::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( amalgam::protocol::version, (v_num) )
FC_REFLECT_DERIVED( amalgam::protocol::hardfork_version, (amalgam::protocol::version), )

FC_REFLECT( amalgam::protocol::hardfork_version_vote, (hf_version)(hf_time) )
