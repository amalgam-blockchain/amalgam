...
//
// Place AMALGAM_DEFINE_OPERATION_TYPE in a .cpp file to define
// functions related to your operation type
//
#define AMALGAM_DEFINE_OPERATION_TYPE( OperationType )                       \
                                                                           \
namespace amalgam { namespace protocol {                                     \
                                                                           \
void operation_validate( const OperationType& op )                         \
{                                                                          \
   op.visit( amalgam::protocol::operation_validate_visitor() );              \
}                                                                          \
                                                                           \
...
{                                                                          \
   op.visit( amalgam::protocol::get_required_auth_visitor( active, owner, posting, other ) ); \
}                                                                          \
                                                                           \
} } /* amalgam::protocol */
