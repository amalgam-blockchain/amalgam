...
#include <amalgam/protocol/sign_state.hpp>
...
using fc::ecc::canonical_signature_type;
   ...
   struct signed_transaction : public transaction
   {
      ...
      set<public_key_type> get_required_signatures(
         ...
         uint32_t max_membership = AMALGAM_MAX_AUTHORITY_MEMBERSHIP,
         uint32_t max_account_auths = AMALGAM_MAX_SIG_CHECK_ACCOUNTS,
...
FC_REFLECT( amalgam::protocol::transaction, (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions) )
FC_REFLECT_DERIVED( amalgam::protocol::signed_transaction, (amalgam::protocol::transaction), (signatures) )
FC_REFLECT_DERIVED( amalgam::protocol::annotated_signed_transaction, (amalgam::protocol::signed_transaction), (transaction_id)(block_num)(transaction_num) );
