...
namespace amalgam {
   ...
   namespace protocol {
      ...
      #define AMALGAM_INIT_PUBLIC_KEY (amalgam::protocol::public_key_type(AMALGAM_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const amalgam::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  amalgam::protocol::public_key_type& vo );
    void to_variant( const amalgam::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, amalgam::protocol::extended_public_key_type& vo );
    void to_variant( const amalgam::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, amalgam::protocol::extended_private_key_type& vo );
}

FC_REFLECT( amalgam::protocol::public_key_type, (key_data) )
FC_REFLECT( amalgam::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( amalgam::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( amalgam::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( amalgam::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( amalgam::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( amalgam::protocol::share_type )

FC_REFLECT( amalgam::void_t, )
