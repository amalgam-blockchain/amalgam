 ...
 * - Length is between (inclusive) AMALGAM_MIN_ACCOUNT_NAME_LENGTH and AMALGAM_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace amalgam::protocol


FC_REFLECT_TYPENAME( amalgam::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( amalgam::protocol::authority::key_authority_map)
FC_REFLECT( amalgam::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( amalgam::protocol::authority::classification, (owner)(active)(key)(posting) )
