...
fc::variant_object get_config()
{
   ...
   result["AMALGAM_CONTENT_CONSTANT"] = AMALGAM_CONTENT_CONSTANT;
   ...
   result["AMALGAM_CREATE_ACCOUNT_DELEGATION_RATIO"] = AMALGAM_CREATE_ACCOUNT_DELEGATION_RATIO;
   result["AMALGAM_CREATE_ACCOUNT_DELEGATION_TIME"] = AMALGAM_CREATE_ACCOUNT_DELEGATION_TIME;
   result["AMALGAM_CREATE_ACCOUNT_WITH_AMALGAM_MODIFIER"] = AMALGAM_CREATE_ACCOUNT_WITH_AMALGAM_MODIFIER;
   result["AMALGAM_DEFAULT_ABD_INTEREST_RATE"] = AMALGAM_DEFAULT_ABD_INTEREST_RATE;
   result["AMALGAM_EQUIHASH_K"] = AMALGAM_EQUIHASH_K;
   result["AMALGAM_EQUIHASH_N"] = AMALGAM_EQUIHASH_N;
   ...
   result["AMALGAM_INIT_WITNESS_NAME"] = AMALGAM_INIT_WITNESS_NAME;
   result["AMALGAM_INIT_PUBLIC_KEY_STR"] = AMALGAM_INIT_PUBLIC_KEY_STR;
   ...
   result["AMALGAM_INIT_RECENT_CLAIMS"] = AMALGAM_INIT_RECENT_CLAIMS;
   ...
   result["AMALGAM_MAX_COMMENT_DEPTH"] = AMALGAM_MAX_COMMENT_DEPTH;
   ...
   result["AMALGAM_MAX_MINER_WITNESSES"] = AMALGAM_MAX_MINER_WITNESSES;
   result["AMALGAM_MAX_PERMLINK_LENGTH"] = AMALGAM_MAX_PERMLINK_LENGTH;
   ...
   result["AMALGAM_MAX_VOTE_CHANGES"] = AMALGAM_MAX_VOTE_CHANGES;
   ...
   result["AMALGAM_MIN_PERMLINK_LENGTH"] = AMALGAM_MIN_PERMLINK_LENGTH;
   result["AMALGAM_MIN_REPLY_INTERVAL"] = AMALGAM_MIN_REPLY_INTERVAL;
   result["AMALGAM_MIN_ROOT_COMMENT_INTERVAL"] = AMALGAM_MIN_ROOT_COMMENT_INTERVAL;
   result["AMALGAM_MIN_VOTE_INTERVAL_SEC"] = AMALGAM_MIN_VOTE_INTERVAL_SEC;
   result["AMALGAM_MINER_ACCOUNT"] = AMALGAM_MINER_ACCOUNT;
   result["AMALGAM_MIN_FEEDS"] = AMALGAM_MIN_FEEDS;
   result["AMALGAM_MIN_PAYOUT_ABD"] = AMALGAM_MIN_PAYOUT_ABD;
   ...
   result["AMALGAM_NUM_INIT_WITNESSES"] = AMALGAM_NUM_INIT_WITNESSES;
   ...
   result["AMALGAM_POST_REWARD_FUND_NAME"] = AMALGAM_POST_REWARD_FUND_NAME;
   ...
   result["AMALGAM_RECENT_RSHARES_DECAY_RATE"] = AMALGAM_RECENT_RSHARES_DECAY_RATE;
   result["AMALGAM_REVERSE_AUCTION_WINDOW_SECONDS"] = AMALGAM_REVERSE_AUCTION_WINDOW_SECONDS;
   result["AMALGAM_ROOT_POST_PARENT"] = AMALGAM_ROOT_POST_PARENT;
   ...
   result["AMALGAM_SOFT_MAX_COMMENT_DEPTH"] = AMALGAM_SOFT_MAX_COMMENT_DEPTH;
   result["AMALGAM_SYMBOL_NAME"] = AMALGAM_SYMBOL_NAME;
   result["AMALGAM_TEMP_ACCOUNT"] = AMALGAM_TEMP_ACCOUNT;
   result["AMALGAM_UPVOTE_LOCKOUT"] = AMALGAM_UPVOTE_LOCKOUT;
   ...
   result["AMALGAM_VOTE_CHANGE_LOCKOUT_PERIOD"] = AMALGAM_VOTE_CHANGE_LOCKOUT_PERIOD;
   result["AMALGAM_VOTE_DUST_THRESHOLD"] = AMALGAM_VOTE_DUST_THRESHOLD;
   result["AMALGAM_VOTE_REGENERATION_SECONDS"] = AMALGAM_VOTE_REGENERATION_SECONDS;
