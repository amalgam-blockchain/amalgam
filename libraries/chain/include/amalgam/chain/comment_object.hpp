...
namespace amalgam { namespace chain {
   ...
   class comment_object : public object < comment_object_type, comment_object >
   {
      ...
      public:
         ...
         /** tracks the total payout this comment has received over time, measured in ABD */
         asset             total_payout_value = asset(0, ABD_SYMBOL);
         asset             curator_payout_value = asset(0, ABD_SYMBOL);
         asset             beneficiary_payout_value = asset( 0, ABD_SYMBOL );
...
FC_REFLECT( amalgam::chain::comment_object,
             ...
             (max_accepted_payout)(percent_amalgam_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )
CHAINBASE_SET_INDEX_TYPE( amalgam::chain::comment_object, amalgam::chain::comment_index )

FC_REFLECT( amalgam::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( amalgam::chain::comment_vote_object, amalgam::chain::comment_vote_index )
