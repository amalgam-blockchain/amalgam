...
namespace amalgam { namespace chain {
   ...
   using amalgam::protocol::chain_properties;
   using amalgam::protocol::digest_type;
   using amalgam::protocol::public_key_type;
   using amalgam::protocol::version;
   using amalgam::protocol::hardfork_version;
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         time_point_sec    hardfork_time_vote = AMALGAM_GENESIS_TIME;
   };
...
CHAINBASE_SET_INDEX_TYPE( amalgam::chain::witness_object, amalgam::chain::witness_index )

FC_REFLECT( amalgam::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( amalgam::chain::witness_vote_object, amalgam::chain::witness_vote_index )
...
CHAINBASE_SET_INDEX_TYPE( amalgam::chain::witness_schedule_object, amalgam::chain::witness_schedule_index )
