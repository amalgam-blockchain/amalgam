...
namespace amalgam { namespace chain {
   ...
   using amalgam::protocol::operation;
   ...
   class database : public chainbase::database
   {
      public:
         ...
         const comment_object&  get_comment(  const shared_string& permlink )const;
         const comment_object*  find_comment( const shared_string& permlink )const;

         const comment_object&  get_comment(  const string& permlink )const;
         const comment_object*  find_comment( const string& permlink )const;
          ...
          *
          * Passing slot_num == 0 returns AMALGAM_NULL_WITNESS
          */
         ...
         void init_schema();
         void init_genesis(uint64_t initial_supply = AMALGAM_INIT_SUPPLY );
   ...
   protected:
      ...
      private:
         ...
         fc::time_point_sec            _hardfork_times[ AMALGAM_NUM_HARDFORKS + 1 ];
         protocol::hardfork_version    _hardfork_versions[ AMALGAM_NUM_HARDFORKS + 1 ];
