...
FC_REFLECT( amalgam::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( amalgam::chain::block_summary_object, amalgam::chain::block_summary_index )
