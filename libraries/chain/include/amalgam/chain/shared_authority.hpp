...
namespace amalgam { namespace chain {
   ...
   using amalgam::protocol::weight_type;
...
FC_REFLECT_TYPENAME( amalgam::chain::shared_authority::account_authority_map)
FC_REFLECT( amalgam::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
