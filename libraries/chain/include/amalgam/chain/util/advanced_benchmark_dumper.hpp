...
FC_REFLECT( amalgam::chain::util::advanced_benchmark_dumper::item, (op_name)(time) )
FC_REFLECT( amalgam::chain::util::advanced_benchmark_dumper::ritem, (op_name)(time) )

FC_REFLECT( amalgam::chain::util::advanced_benchmark_dumper::total_info< std::set< amalgam::chain::util::advanced_benchmark_dumper::item > >, (total_time)(items) )
FC_REFLECT( amalgam::chain::util::advanced_benchmark_dumper::total_info< std::multiset< amalgam::chain::util::advanced_benchmark_dumper::ritem > >, (total_time)(items) )
