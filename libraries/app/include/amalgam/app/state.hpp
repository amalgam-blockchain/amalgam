...
namespace amalgam { namespace app {
   ...
   struct extended_account : public account_api_obj
   {
      ...
      asset                                   vesting_balance; /// convert vesting_shares to vesting amalgam
      share_type                              reputation = 0;
...
FC_REFLECT( amalgam::app::discussion_index, (category)(trending)(payout)(payout_comments)(trending30)(updated)(created)(responses)(active)(votes)(maturing)(best)(hot)(promoted)(cashout) )
FC_REFLECT( amalgam::app::tag_index, (trending) )
FC_REFLECT_DERIVED( amalgam::app::discussion, (amalgam::app::comment_api_obj), (url)(root_title)(pending_payout_value)(total_pending_payout_value)(active_votes)(replies)(author_reputation)(promoted)(body_length)(reblogged_by)(first_reblogged_by)(first_reblogged_on) )

FC_REFLECT( amalgam::app::state, (current_route)(props)(tag_idx)(tags)(content)(accounts)(pow_queue)(witnesses)(discussion_idx)(witness_schedule)(feed_price)(error)(market_data) )
