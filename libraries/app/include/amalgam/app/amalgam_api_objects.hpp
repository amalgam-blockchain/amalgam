...
struct comment_api_obj
{
   comment_api_obj( const chain::comment_object& o ):
      ...
      percent_amalgam_dollars( o.percent_amalgam_dollars ),
   ...
   uint16_t          percent_amalgam_dollars = 0;
...
struct account_api_obj
{
   account_api_obj( const chain::account_object& a, const chain::database& db ) :
      ...
      reward_abd_balance( a.reward_abd_balance ),
      reward_amalgam_balance( a.reward_amalgam_balance ),
      reward_vesting_balance( a.reward_vesting_balance ),
      reward_vesting_amalgam( a.reward_vesting_amalgam ),
   ...
   asset             reward_abd_balance;
   asset             reward_amalgam_balance;
   asset             reward_vesting_balance;
   asset             reward_vesting_amalgam;
...
FC_REFLECT( amalgam::app::account_api_obj,
             ...
             (reward_abd_balance)(reward_amalgam_balance)(reward_vesting_balance)(reward_vesting_amalgam)
