#include <amalgam/plugins/chain_api/chain_api_plugin.hpp>
#include <amalgam/plugins/chain_api/chain_api.hpp>
...
{
   JSON_RPC_REGISTER_API( AMALGAM_CHAIN_API_PLUGIN_NAME );
}
