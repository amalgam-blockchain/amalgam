...
#define AMALGAM_MARKET_HISTORY_API_PLUGIN_NAME "market_history_api"
...
public:
   APPBASE_PLUGIN_REQUIRES(
      (amalgam::plugins::market_history::market_history_plugin)
   ...
   static const std::string& name() { static std::string name = AMALGAM_MARKET_HISTORY_API_PLUGIN_NAME; return name; }
