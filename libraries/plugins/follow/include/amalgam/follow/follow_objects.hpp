 ...
 *  how frequently. It is designed to give an overview of the type of people a blogger sponsors as well
...
FC_REFLECT_ENUM( amalgam::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( amalgam::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( amalgam::follow::follow_object, amalgam::follow::follow_index )

FC_REFLECT( amalgam::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( amalgam::follow::feed_object, amalgam::follow::feed_index )

FC_REFLECT( amalgam::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( amalgam::follow::blog_object, amalgam::follow::blog_index )

FC_REFLECT( amalgam::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( amalgam::follow::reputation_object, amalgam::follow::reputation_index )

FC_REFLECT( amalgam::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( amalgam::follow::follow_count_object, amalgam::follow::follow_count_index )

FC_REFLECT( amalgam::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( amalgam::follow::blog_author_stats_object, amalgam::follow::blog_author_stats_index );
