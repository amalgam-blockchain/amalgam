...
class reserve_ratio_object : public object< reserve_ratio_object_type, reserve_ratio_object >
{
   public:
       ...
       *   reaches AMALGAM_MAX_RESERVE_RATIO.  Any time average_block_size is greater than
       ...
       *
       *    max_bandwidth = maximum_block_size * AMALGAM_BANDWIDTH_AVERAGE_WINDOW_SECONDS / AMALGAM_BLOCK_INTERVAL
       *
...
FC_REFLECT_ENUM( amalgam::plugins::witness::bandwidth_type, (forum)(market) )

FC_REFLECT( amalgam::plugins::witness::account_bandwidth_object,
            (id)(account)(type)(average_bandwidth)(lifetime_bandwidth)(last_bandwidth_update) )
CHAINBASE_SET_INDEX_TYPE( amalgam::plugins::witness::account_bandwidth_object, amalgam::plugins::witness::account_bandwidth_index )

FC_REFLECT( amalgam::plugins::witness::reserve_ratio_object,
            (id)(average_block_size)(current_reserve_ratio)(max_virtual_bandwidth) )
CHAINBASE_SET_INDEX_TYPE( amalgam::plugins::witness::reserve_ratio_object, amalgam::plugins::witness::reserve_ratio_index )
