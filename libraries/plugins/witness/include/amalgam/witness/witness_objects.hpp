...
CHAINBASE_SET_INDEX_TYPE( amalgam::witness::account_bandwidth_object, amalgam::witness::account_bandwidth_index )

FC_REFLECT( amalgam::witness::content_edit_lock_object,
            (id)(account)(lock_time) )
CHAINBASE_SET_INDEX_TYPE( amalgam::witness::content_edit_lock_object, amalgam::witness::content_edit_lock_index )

FC_REFLECT( amalgam::witness::reserve_ratio_object,
            (id)(average_block_size)(current_reserve_ratio)(max_virtual_bandwidth) )
CHAINBASE_SET_INDEX_TYPE( amalgam::witness::reserve_ratio_object, amalgam::witness::reserve_ratio_index )
