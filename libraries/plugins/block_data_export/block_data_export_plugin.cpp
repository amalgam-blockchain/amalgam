...
namespace amalgam { namespace plugins { namespace block_data_export {
...
FC_REFLECT( amalgam::plugins::block_data_export::detail::api_export_data_object, (block_id)(previous)(export_data) )

namespace amalgam { namespace plugins { namespace block_data_export { namespace detail {
...
} } } // amalgam::plugins::block_data_export
