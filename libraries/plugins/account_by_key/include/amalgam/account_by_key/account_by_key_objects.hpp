...
FC_REFLECT( amalgam::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( amalgam::account_by_key::key_lookup_object, amalgam::account_by_key::key_lookup_index )
