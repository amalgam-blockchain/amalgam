...
using amalgam::protocol::fill_order_operation;
      ...
      for( auto bucket : _tracked_buckets )
      {
         ...
         if( itr == bucket_idx.end() )
         {
            db.create< bucket_object >( [&]( bucket_object& b )
            {
               ...
               if( op.open_pays.symbol == AMALGAM_SYMBOL )
               {
                  b.high_amalgam = op.open_pays.amount;
                  b.high_abd = op.current_pays.amount;
                  b.low_amalgam = op.open_pays.amount;
                  b.low_abd = op.current_pays.amount;
                  b.open_amalgam = op.open_pays.amount;
                  b.open_abd = op.current_pays.amount;
                  b.close_amalgam = op.open_pays.amount;
                  b.close_abd = op.current_pays.amount;
                  b.amalgam_volume = op.open_pays.amount;
                  b.abd_volume = op.current_pays.amount;
               }
               else
               {
                  b.high_amalgam = op.current_pays.amount;
                  b.high_abd = op.open_pays.amount;
                  b.low_amalgam = op.current_pays.amount;
                  b.low_abd = op.open_pays.amount;
                  b.open_amalgam = op.current_pays.amount;
                  b.open_abd = op.open_pays.amount;
                  b.close_amalgam = op.current_pays.amount;
                  b.close_abd = op.open_pays.amount;
                  b.amalgam_volume = op.current_pays.amount;
                  b.abd_volume = op.open_pays.amount;
               }
            });
         }
         else
...
AMALGAM_DEFINE_PLUGIN( market_history, amalgam::market_history::market_history_plugin )
