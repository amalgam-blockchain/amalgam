...
#include <amalgam/market_history/market_history_plugin.hpp>
...
{
   public:
      market_history_api( const amalgam::app::api_context& ctx );

      void on_api_startup();

      /**
       * @brief Returns the market ticker for the internal ABD:AMALGAM market
       */
      ...
      /**
       * @brief Returns the current order book for the internal ABD:AMALGAM market.
      ...
      /**
       * @brief Returns the trade history for the internal ABD:AMALGAM market.
      ...
      /**
       * @brief Returns the N most recent trades for the internal ABD:AMALGAM market.
      ...
      /**
       * @brief Returns the market history for the internal ABD:AMALGAM market.
...
FC_REFLECT( amalgam::market_history::market_ticker,
   (latest)(lowest_ask)(highest_bid)(percent_change)(amalgam_volume)(abd_volume) );
FC_REFLECT( amalgam::market_history::market_volume,
   (amalgam_volume)(abd_volume) );
FC_REFLECT( amalgam::market_history::order,
   (price)(amalgam)(abd) );
FC_REFLECT( amalgam::market_history::order_book,
   (bids)(asks) );
FC_REFLECT( amalgam::market_history::market_trade,
   (date)(current_pays)(open_pays) );

FC_API( amalgam::market_history::market_history_api,
   (get_ticker)
   (get_volume)
   (get_order_book)
   (get_trade_history)
