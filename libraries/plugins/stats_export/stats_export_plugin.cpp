...
#include <amalgam/plugins/block_data_export/exportable_block_data.hpp>

#include <amalgam/plugins/stats_export/stats_export_plugin.hpp>
...
using amalgam::chain::block_notification;
using amalgam::chain::database;
using amalgam::chain::dynamic_global_property_object;

using amalgam::protocol::account_name_type;
using amalgam::protocol::authority;
using amalgam::protocol::signed_transaction;

using amalgam::plugins::block_data_export::block_data_export_plugin;
using amalgam::plugins::block_data_export::exportable_block_data;

using amalgam::plugins::chain::chain_plugin;
...
FC_REFLECT( amalgam::plugins::stats_export::detail::api_stats_transaction_data_object, (user)(size) )
FC_REFLECT( amalgam::plugins::stats_export::detail::api_stats_export_data_object, (global_properties)(transaction_stats)(free_memory) )

namespace amalgam { namespace plugins { namespace stats_export { namespace detail {
...
{
   std::shared_ptr< api_stats_export_data_object > stats = _export_plugin.find_export_data< api_stats_export_data_object >( AMALGAM_STATS_EXPORT_PLUGIN_NAME );
   if( !stats )
      return;
...
void stats_export_plugin::plugin_initialize( const boost::program_options::variables_map& options )
{
   ...
   try
   {
      ...
      my->_export_plugin.register_export_data_factory( AMALGAM_STATS_EXPORT_PLUGIN_NAME,
