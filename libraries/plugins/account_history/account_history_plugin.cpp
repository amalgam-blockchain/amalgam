#include <amalgam/account_history/account_history_plugin.hpp>
...
namespace amalgam { namespace account_history {
...
void account_history_plugin_impl::on_operation( const operation_notification& note )
{
   ...
   amalgam::chain::database& db = database();
...
AMALGAM_DEFINE_PLUGIN( account_history, amalgam::account_history::account_history_plugin )
