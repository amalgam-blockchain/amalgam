#pragma once
#include <amalgam/plugins/statsd/statsd_plugin.hpp>

#include <fc/optional.hpp>
#include <fc/time.hpp>

namespace amalgam { namespace plugins { namespace statsd { namespace util {

using amalgam::plugins::statsd::statsd_plugin;
...
} } } } // amalgam::plugins::statsd::util

#define STATSD_INCREMENT( NAMESPACE, STAT, KEY, FREQ )   \
if( amalgam::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   amalgam::plugins::statsd::util::get_statsd().increment( \
...
if( amalgam::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   amalgam::plugins::statsd::util::get_statsd().decrement( \
      NAMESPACE, STAT, KEY, FREQ                         \
   );                                                    \
}
...
if( amalgam::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   amalgam::plugins::statsd::util::get_statsd().count(     \
...
if( amalgam::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   amalgam::plugins::statsd::util::get_statsd().gauge(     \
      NAMESPACE, STAT, KEY, VAL, FREQ                    \
   );                                                    \
}
...
fc::optional< amalgam::plugins::statsd::util::statsd_timer_helper > statsd_timer;  \
if( amalgam::plugins::statsd::util::statsd_enabled() )                             \
{                                                                                \
   statsd_timer = amalgam::plugins::statsd::util::statsd_timer_helper(             \
      NAMESPACE, STAT, KEY, FREQ, amalgam::plugins::statsd::util::get_statsd()     \
   );                                                                            \
}
...
if( amalgam::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   amalgam::plugins::statsd::util::get_statsd().timing(    \
      NAMESPACE, STAT, KEY,                              \
      amalgam::plugins::statsd::util::timing_helper( VAL ),\
      FREQ                                               \
   );                                                    \
}
