...
#define AMALGAM_STATSD_PLUGIN_NAME "statsd"

namespace amalgam { namespace plugins { namespace statsd {
...
class statsd_plugin : public appbase::plugin< statsd_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = AMALGAM_STATSD_PLUGIN_NAME; return name; }
