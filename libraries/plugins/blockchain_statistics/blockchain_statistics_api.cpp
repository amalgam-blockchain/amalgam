#include <amalgam/blockchain_statistics/blockchain_statistics_api.hpp>

namespace amalgam { namespace blockchain_statistics {
...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( amalgam::app::application& app )
            :_app( app ) {}
...
blockchain_statistics_api::blockchain_statistics_api( const amalgam::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->amalgam_transferred                      += b.amalgam_transferred;
   this->abd_transferred                        += b.abd_transferred;
   this->abd_paid_as_interest                   += b.abd_paid_as_interest;
   ...
   this->abd_paid_to_authors                    += b.abd_paid_to_authors;
   ...
   this->amalgam_vested                           += b.amalgam_vested;
   ...
   this->abd_conversion_requests_created        += b.abd_conversion_requests_created;
   this->abd_to_be_converted                    += b.abd_to_be_converted;
   this->abd_conversion_requests_filled         += b.abd_conversion_requests_filled;
   this->amalgam_converted                        += b.amalgam_converted;
