...
#include <amalgam/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
struct statistics
{
   ...
   share_type           amalgam_transferred = 0;                       ///< AMALGAM transferred from account to account
   share_type           abd_transferred = 0;                         ///< ABD transferred from account to account
   ...
   share_type           vests_paid_to_authors = 0;                   ///< Ammount of VESTS paid to authors
   ...
   share_type           vests_withdrawn = 0;                         ///< Ammount of VESTS withdrawn to AMALGAM
...
{
   public:
      blockchain_statistics_api( const amalgam::app::api_context& ctx );
...
FC_REFLECT( amalgam::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( amalgam::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
