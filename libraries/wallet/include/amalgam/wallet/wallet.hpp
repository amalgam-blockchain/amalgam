...
class wallet_api
{
   public:
       ...
       *
       * example: import_key 5JQ4bmBSUdpzk4j8UsGjpbK44Fa6YWKniSDismEwoFxt9iTetDD
       *
       ...
       * @param abd_amount The amount of ABD to transfer
       * @param amalgam_amount The amount of AMALGAM to transfer
       ...
       * @param escrow_id A unique id for the escrow transfer
       * @param abd_amount The amount of ABD that will be released
       * @param amalgam_amount The amount of AMALGAM that will be released
       * @param broadcast true if you wish to broadcast the transaction
       */
      ...
      /**
       * Transfer AMALGAM into a vesting fund represented by vesting shares (VESTS). VESTS are required to vesting
       * for a minimum of one coin year and can be withdrawn once a week over a two year withdraw period.
       * VESTS are protected against dilution up until 90% of AMALGAM is vesting.
       *
       ...
       *
       *  @param from The account requesting conversion of its ABD i.e. "1.000 ABD"
       ...
       * to process conversion requests from ABD to AMALGAM.
       *
       ...
       *                       operations defined in `amalgam/chain/operations.hpp`
       ...
       *  @param amount_to_sell The amount of either ABD or AMALGAM you wish to sell
...
FC_REFLECT( amalgam::wallet::wallet_data,
            (cipher_keys)
            (ws_server)
            (ws_user)
            (ws_password)
...
FC_REFLECT( amalgam::wallet::brain_key_info, (brain_priv_key)(wif_priv_key) (pub_key))

FC_REFLECT( amalgam::wallet::plain_keys, (checksum)(keys) )
...
FC_REFLECT( amalgam::wallet::memo_data, (from)(to)(nonce)(check)(encrypted) )
