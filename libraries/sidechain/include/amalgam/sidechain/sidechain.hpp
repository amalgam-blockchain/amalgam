...
namespace amalgam { namespace sidechain {
  using std::string;
...
#define side_ids 10
  ...
  FC_REFLECT_DERIVED( amalgam::sidechain::side_account, (graphene::db::object),
                      (sidechain)(name)(amalgam_balance)(dollar_balance)
                     );
