...
#define AMALGAM_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
AMALGAM_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define AMALGAM_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define AMALGAM_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define AMALGAM_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
AMALGAM_DECLARE_SCHEMA_CLASS( false, false )
AMALGAM_DECLARE_SCHEMA_CLASS(  true, false )
AMALGAM_DECLARE_SCHEMA_CLASS(  true,  true )
